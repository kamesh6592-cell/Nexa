...
export const GitHubDeployModal: React.FC<{ onClose: () => void; }> = ({ onClose }) => {
    ...
    const renderContent = () => {
        switch (step) {
            case 'connect':
                return (
                    <>
                        <h3 className="text-2xl font-bold text-brand-charcoal">Guided Deployment</h3>
                        <p className="text-brand-charcoal/70 mt-2">Let's get your new website on the web! This guide will walk you through deploying with GitHub.</p>
                        <p className="text-brand-charcoal/70 mt-2">First, what would you like to name your repository?</p>
                        ...
                        <div className="mt-6 space-y-4">
                            <input
                                ...
                                className="w-full bg-brand-cream border-2 border-brand-charcoal/10 rounded-xl p-3 focus:ring-2 focus:ring-brand-coral"
                            />
                            <button
            ...
            case 'success':
                 ...
                 return (
                    <div className="text-center">
                        ...
                        <h3 className="text-3xl font-bold text-brand-charcoal mt-6">Ready for Launch!</h3>
                        ...
                        <div className="text-left mt-6 space-y-3 max-h-[40vh] overflow-y-auto pr-2">
                             {/* Step 1 */}
                            <div className="bg-brand-sky/50 p-3 rounded-lg">
                                <h4 className="font-bold text-brand-charcoal">Step 1: Create a GitHub Repository</h4>
                                <p className="text-sm text-brand-charcoal/80 mt-1">Go to GitHub and create a new public repository named <b className="font-semibold">{repoName}</b>. Don't initialize it with a README.</p>
                             ...
                             {/* Step 2 */}
                            <div className="bg-brand-sky/50 p-3 rounded-lg">
                                <h4 className="font-bold text-brand-charcoal">Step 2: Upload Your Code</h4>
                                <p className="text-sm text-brand-charcoal/80 mt-1">
                                ...
                                <p className="text-xs text-brand-charcoal/60 mt-2">Remember to replace `YOUR_USERNAME` in the 'remote' command!</p>
                            </div>

                             {/* Step 3 */}
                             <div className="bg-brand-sky/50 p-3 rounded-lg">
                                <h4 className="font-bold text-brand-charcoal">Step 3: Enable GitHub Pages</h4>
                                <p className="text-sm text-brand-charcoal/80 mt-1">In your new repository's settings, go to the "Pages" section. Under "Build and deployment", select the <b className="font-semibold">main</b> branch as your source and click "Save". Your site will be live in a few minutes!</p>
                            </div>
                        </div>
    ...
    return (
        <div className="fixed inset-0 bg-brand-charcoal/50 backdrop-blur-sm flex items-center justify-center z-50 p-4" onClick={onClose}>
            ...
            `}</style>
            <div 
                className="bg-white rounded-3xl shadow-2xl w-full max-w-lg p-8 animate-[popIn_0.3s_ease-out_forwards]" 
